...
export default {
  ...
  methods: {
    ...
    Task_PDF() {
      ...
      let columns = [
        { title: self.$t("title"), dataKey: "title" },
        { title: self.$t("Project"), dataKey: "project_title" },
        { title: self.$t("Company"), dataKey: "company_name" },
        { title: self.$t("start_date"), dataKey: "start_date" },
        { title: self.$t("Finish_Date"), dataKey: "end_date" }
      ];
